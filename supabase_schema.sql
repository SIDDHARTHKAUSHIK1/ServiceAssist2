...
-- 7. RLS POLICIES (Allow public/anon read and write for the Android client)
-- User Profiles
...
-- ==========================================================
-- 8. COMPREHENSIVE DEMO DATA SEEDING
-- ==========================================================
...
INSERT INTO public.saved_addresses (id, title, full_address, locality, city, landmark, is_default)
VALUES
(1, 'Home', 'Flat 402, Royal Residency, Taj Nagri Phase 2', 'Taj Nagri Phase 2', 'Agra', 'Near Shilpgram East Gate', true),
(2, 'Office', 'Suite 305, Corporate Plaza, Sanjay Place', 'Sanjay Place', 'Agra', 'Opposite LIC Building', false),
(3, 'Parents Home', 'B-14, Radhasoami Colony, Dayalbagh Main Road', 'Dayalbagh', 'Agra', 'Near Radhasoami Temple', false),
(4, 'Farmhouse', 'Villa 7, Shamshabad Road Green Acres', 'Shamshabad Road', 'Agra', 'Behind Toll Plaza', false)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public.bookings (id, booking_code, service_id, service_name, package_name, scheduled_date, scheduled_time, address_text, locality, city, total_amount, discount_amount, promo_code, payment_method, is_paid, status, professional_id, start_otp, special_notes)
VALUES
(1, 'SRV-84920', 'ac_service_deep', 'Intense AC Foam Jet Service', '1 Split AC Deep Jet Cleaning', 'Today', '02:30 PM', 'Flat 402, Royal Residency, Taj Nagri Phase 2, Agra', 'Taj Nagri Phase 2', 'Agra', 499, 100, 'FIRST20', 'Cash after service', false, 'ON_THE_WAY', 'pro_rajesh_1', '6824', 'Please ring bell twice, AC is in master bedroom.'),
(2, 'SRV-95012', 'plumbing_leak_fix', 'Pipe Leakage & Tap Fix', 'Drain & Pipe Repair', 'Tomorrow', '11:00 AM', 'Suite 305, Corporate Plaza, Sanjay Place, Agra', 'Sanjay Place', 'Agra', 249, 50, 'AGRA50', 'UPI (Google Pay)', true, 'ASSIGNED', 'pro_kavita_4', '3912', 'Pantry sink tap is leaking continuously.'),
(3, 'SRV-73105', 'deep_home_cleaning', 'Complete Home Deep Cleaning', '2 BHK Intensive Deep Clean', '12 Sep 2026', '10:00 AM', 'Flat 402, Royal Residency, Taj Nagri Phase 2, Agra', 'Taj Nagri Phase 2', 'Agra', 1899, 200, 'CLEAN100', 'UPI (PhonePe)', true, 'COMPLETED', 'pro_amit_2', '3194', 'Completed thoroughly with hospital-grade sanitizers.'),
(4, 'SRV-61294', 'salon_women_glow', 'Glow Facial & Mani-Pedi', 'Bridal Radiance Package', '08 Sep 2026', '04:00 PM', 'B-14, Radhasoami Colony, Dayalbagh Main Road, Agra', 'Dayalbagh', 'Agra', 1299, 150, 'FESTIVE15', 'Card Payment', true, 'COMPLETED', 'pro_meera_3', '8401', 'Disposable sterilized equipment used.'),
(5, 'SRV-54911', 'electrician_instant', 'Electrical Short Circuit & Wiring', 'Emergency Repair', '01 Sep 2026', '06:30 PM', 'Villa 7, Shamshabad Road Green Acres, Agra', 'Shamshabad Road', 'Agra', 399, 0, '', 'Cash after service', true, 'COMPLETED', 'pro_rajesh_1', '1928', 'Fixed main MCB trip and neutralized earthing.')
ON CONFLICT (id) DO UPDATE SET
